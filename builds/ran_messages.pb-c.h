...
typedef enum _RANMcsType {
  RAN_MCS_TYPE__SIXTEEN_QAM = 1,
  RAN_MCS_TYPE__SIXTYFOUR_QAM = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(RAN_MCS_TYPE)
} RANMcsType;
...
#define UE_INFO_M__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ue_info_m__descriptor) \
    , 0, 0, 0, 0, 0, 0, 0, 0, RAN_MCS_TYPE__SIXTEEN_QAM, 0, 0 }
...
extern const ProtobufCEnumDescriptor    ran_mcs_type__descriptor;
